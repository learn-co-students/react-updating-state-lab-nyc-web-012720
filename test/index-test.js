...
describe('<DigitalClicker />', () => {
  it.only('should have the correct initial state', () => {
  ...
  it.only('should update the count when the button is clicked', () => {
    const wrapper = shallow(<DigitalClicker />);
  ...
  it.only('should update the button label when the state changes', () => {
    const wrapper = shallow(<DigitalClicker />);
...
describe('<YouTubeDebugger />', () => {
  ...
  it.only('should update the bitrate when the `.bitrate` button is clicked', () => {
    const wrapper = shallow(<YouTubeDebugger />);
  ...
  it.only('should update the video resolution when the `.resolution` button is clicked', () => {
    const wrapper = shallow(<YouTubeDebugger />);
    const expectedState = deepClone(BASE_STATE);
